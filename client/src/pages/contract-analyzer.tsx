...
• Готовность к отгрузке: В случае самовывоза Поставщик обязан письменно уведомить Покупателя о готовности Товара к отгрузке не менее чем за 3 (три) рабочих дня до предполагаемой даты отгрузки, указав точный адрес склада, время работы и контактное лицо.
• Маркировка: Каждая единица тары/упаковки Товара должна иметь четкую маркировку на русском языке, содержащую наименование Товара, сведения о производителе, номер партии, дату изготовления, вес нетто/брутто и манипуляционные знаки.
• Персональные данные: Стороны обязуются соблюдать требования Федерального закона № 152-ФЗ "О персональных данных" при обработке персональных данных представителей и сотрудников друг друга, полученных в ходе исполнения Договора.
